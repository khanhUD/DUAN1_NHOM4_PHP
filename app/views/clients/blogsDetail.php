                     ...
                     <article class="blog-detail">
                         ...
                         <div class="comments mt-5">
                             ...
                             <?php
                                ...
                                ?>
                                 <div class="mb-3">
                                     <p class="tex-success">Bạn phải đăng nhập mới có thể bình luận bài viết này này!</p> <a class="text-decoration-none text-success fw-bold" href="<?= $SITE_URL ?>/tai-khoan?login">Đăng nhập</a>
                                 </div>
                             <?php
                                // }
                                ?>
