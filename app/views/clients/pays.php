                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-input mb-3">
                            ...
                            <textarea type="text" id="full-name" name="full-name" class="form-control"
                                placeholder="Ghi chú về đơn hàng, ví dụ: chỉ dẫn địa chỉ chi tiết hơn"></textarea>
                            <span class="error-message">
                            </span>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="voucher pt-3 pb-3">
                                <div class="d-flex justify-content-between">
                                    <input type="text" id="voucher-code" class="form-control input-voucher" name="voucher"
                            ...
                            <div class="div">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end"><input type="submit" class="btn btn-primary btn-order"
                                                value="Đặt hàng"></td>
                                    </tr>
                                </table>
                            </div>
