                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th>Hình ảnh</th>
                                <th class="pe-0" style="max-width: 400px;">Tên bài viết</th> <!--ghi chú là màu đỏ khi ch duyệt-->
                                <th>Chức năng</th>
                            </tr>
                        </thead>
                        <tbody class="table-border-bottom-0">
                            <tr>
                                ...
                                <td>
                                <a class="dropdown-item" href="javascript:void(0);"><i class="bi bi-eye-fill me-1"></i> Xem chi tiết</a>
                                </td>
                            </tr>
