                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <tr>
                                <td style="width: 200px;">
                                    <img width="50%" class=" img" src="<?_WEB_ROOT?>/public/uploads/<?=$items['posts_img']?>" alt="">
                                </td>
                                <td>
                                    <div class="mb-3" style="border-left: 2px solid #72757e; background-color: #eff0f3; max-width: 500px; overflow: hidden; white-space: normal; text-align: justify;">
                                        <a href="<?=_WEB_ROOT?>" class="m-0 p-1 ms-1 pe-3"><?=$items['posts_title']?></a>
                                    </div>
                                ...
                                <td style="width: 200px;">
                                    <a class="" href="<?_WEB_ROOT?>/postComments/commentDetails?id=<?=$items['posts_id']?>"><i class="bi bi-eye-fill me-1"></i> Xem chi tiết</a>
                                </td>
                            </tr>
                                <?php endforeach;?>
                        </tbody>
