                        ...
                        <tbody class="table-border-bottom-0">
                            <?php foreach ($orders as $items) : ?>
                                <tr>
                                    <td><?= $items['id'] ?></td>
                                    <td>
                                        <div class="mb-1"><?= $items['full_name'] ?>[ <span class="text-primary fw-italic">vinhlh@gmail.com</span> ]:</div>
                                    ...
                                    <td>120000</td>
                                    <td>
                                        <span class="badge <?= $items['status'] === 'accepted' ? 'bg-label-primary' : 'bg-label-danger' ?> me-1">
                                            <?= $items['status'] === 'accepted' ? 'Đã Giao' : 'Chờ giao' ?>
                                        </span>
                                    </td>
                                    <td>
                                        <div class="dropdown">
